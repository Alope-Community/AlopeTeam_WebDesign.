...
export default function LocationAccordionSection() {
  ...
  return (
    <section className="py-8 mx-5 md:mx-20 min-h-screen mt-16">
      <div id="accordionExample">
        <div className="rounded-t-lg border bg-light-dark">
          <h2 className="mb-0" id="headingOne">
            <button
              className={`group relative flex w-full items-center rounded-t-[15px] border-0 bg-light-dark px-5 py-4 text-left text-base transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none text-gray-100`}
              type="button"
      ...
      <div className="border border-t-0 bg-light-dark">
        <h2 className="mb-0" id="headingTwo">
          <button
            className={`group relative flex w-full items-center rounded-t-[15px] border-0 px-5 py-4 text-left text-base transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none bg-light-dark text-gray-100`}
            type="button"
      ...
      <div className="rounded-b-lg border border-t-0 bg-light-dark">
