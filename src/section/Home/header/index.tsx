...
export default function HomeHeaderSection({ lang }: { lang?: string }) {
  return (
    <>
      ...
      <header className="h-screen bg-[url('/hero1.jpg')] bg-cover relative after:absolute after:inset-0 after:bg-gradient-to-t from-[#0e1317] to to-[#0e1317]/50 flex items-center justify-center">
